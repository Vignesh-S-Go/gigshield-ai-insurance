            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex justify-between items-end">
                                    <div>
                                        ...
                                        <span className="text-4xl font-black text-white">₹{finalPremium}</span>
                                    </div>
                                    <div className="text-right">
                                        <span className="text-[10px] text-dark-500 font-bold bg-dark-800 px-2 py-1 rounded">AUTO-DEBIT</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        {/* Pay-As-You-Ride */}
                        <div className="bg-dark-900 border border-dark-800 rounded-3xl p-6 shadow-xl relative overflow-hidden group">
                            <Bike className="absolute -right-6 -bottom-6 w-32 h-32 text-slate-800/10 group-hover:-translate-x-4 transition-transform" />
                    ...
                    <div className="bg-dark-900 border border-dark-800 rounded-3xl p-6 shadow-xl">
                        <div className="flex items-center justify-between mb-8">
                            ...
                            <div className="flex items-center gap-2">
                                <span className="text-[10px] font-bold text-dark-400 bg-dark-800 px-2 py-1 rounded">LIVE SENSOR DATA</span>
                            </div>
                        </div>

                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div className="flex flex-col items-center text-center p-4 bg-dark-800/30 rounded-2xl border border-dark-700/50 hover:border-primary-500/30 transition-colors">
                                ...
                                <span className="text-2xl font-black text-white mt-1">{worker.rainfall}mm</span>
                            </div>
                            <div className="flex flex-col items-center text-center p-4">
                                <div className="w-px h-12 bg-dark-800 hidden md:block" />
                                <div className="flex flex-col items-center">
                                    <span className="text-[10px] font-black text-primary-500 uppercase tracking-[0.2em] mb-2">Threshold</span>
                                    <div className="px-4 py-1.5 rounded-lg border-2 border-dashed border-dark-700 font-mono text-lg font-bold">
                                        {worker.threshold}mm
                                    </div>
                                </div>
                                <div className="w-px h-12 bg-dark-800 hidden md:block" />
                            </div>
                            <div className="flex flex-col items-center text-center p-4 bg-success-500/5 rounded-2xl border border-success-500/20 shadow-[0_0_15px_rgba(16,185,129,0.05)]">
                                ...
                                <span className="text-xl font-black text-white mt-1 uppercase tracking-tight">PAYOUT TRIGGERED ✅</span>
                            </div>
                        </div>
                    ...
                    <div className="bg-dark-900 border border-dark-800 rounded-3xl p-6 shadow-xl">
                        ...
                        <div className="space-y-3">
                            {coverageItems.map((item, idx) => (
                                <div key={idx} className="group flex items-center justify-between p-4 bg-dark-800/50 rounded-2xl border border-dark-700 hover:border-success-500/50 transition-all cursor-default">
                                    <div className="flex items-center gap-4">
                                    ...
                                    <div className="w-5 h-5 rounded-full bg-success-500 text-dark-950 flex items-center justify-center">
                    ...
                    <div className="bg-dark-900 border border-dark-800 rounded-3xl p-6 shadow-xl relative overflow-hidden">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            {exclusions.map((item, idx) => (
                                <div key={idx} className="p-3 bg-danger-500/5 border border-danger-500/20 rounded-2xl">
                        ...
                        <p className="text-[10px] text-dark-600 mt-6 leading-relaxed">
                            * Claims for excluded events are automatically filtered by the algorithmic rules engine.
                        </p>
                    </div>

                    {/* Risk-Based Benefits */}
                    <div className="bg-gradient-to-br from-dark-800 to-dark-900 border border-dark-700 rounded-3xl p-6 shadow-xl">
